...
from Datasets.Scalar_on_Function.Real.CanadianWeather.train_functions import train_lstm
...
hyperparameters = {'lstm_hidden1'        : tune.choice([10, 25, 50, 100, 150, 200]),
                   'lstm_hidden2'        : tune.choice([10, 25, 50, 100, 150, 200]),
