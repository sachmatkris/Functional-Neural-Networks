...
from Datasets.Function_on_Function.Simulation.train_functions import train_ffbnn
...
hyperparameters = {'in_base'            : tune.choice(['fourier', 'bspline']),
                   'hidden_base'        : tune.choice(['fourier', 'bspline']),
                   'in_base_n'          : tune.choice([5, 9, 15, 21]),
                   'hidden_base_n'      : tune.choice([5, 9, 15, 21]),
