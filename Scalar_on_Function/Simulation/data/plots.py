...
X = pd.read_csv('Scalar_on_Function/Simulation/data/task 1/B1_G1/snr0.5/X/X.csv', header = None)
...
plt.savefig('Scalar_on_Function/Simulation/data/X(t)_sample_of_20.png', dpi=600, transparent=True)
...
axs[1].legend()
plt.savefig('Scalar_on_Function/Simulation/data/beta_weights.png', dpi=600, transparent=True)
plt.show()